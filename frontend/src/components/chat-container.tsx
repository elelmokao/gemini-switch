              ...
              >
                ...
                <div
                  className={
                    ...
                    (isAssistant ? "text-left" : "text-right ml-auto")
                  }
                >
                  {isAssistant ? (
                    <div className="bg-secondary text-foreground prose rounded-lg p-2 text-left">
                      <Markdown>{message.content}</Markdown>
                    </div>
                  ) : (
                    <MessageContent className="bg-primary text-primary-foreground text-right">
                      {message.content}
                    </MessageContent>
                  )}
                </div>
